...
void MsgThread::OnSignalStop()
	...
	SendIn(new detail::FinishMessage(this, net::network_time), true);
	}
...
void MsgThread::Heartbeat()
	...
	SendIn(new detail::HeartbeatMessage(this, net::network_time, util::current_time()));
	}
